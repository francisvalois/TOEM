...
\end{align*}
\newpage
\subsection{Présentation des courbes théoriques de régime transitoire}
Les courbes théoriques utiles pour l'analyse et la discussion sont présentées ci-dessous.

\begin{figure}[htb]
	\centering
\mbox{\subfigure[Régime transitoire théorique pour $R = 0 \Omega$]{\includegraphics[scale =0.25]{fig/r0.png} \label{fig:r0}}
		\subfigure[Régime transitoire théorique pour $R = 27 \Omega$]{\includegraphics[scale =0.25]{fig/r27.png} \label{fig:r27}}}
		\subfigure[Régime transitoire théorique pour $R = 50 \Omega$]{\includegraphics[scale =0.25]{fig/r50.png} \label{fig:r50}}
\end{figure}


\newpage
\subsection{Présentation des diagrammes en z}
Cette section présente les diagrammes en z qui ont été réalisés au moyen du logiciel matlab et du programme disponible sur le site web du cours.
\begin{figure}[htb]
	\centering
\mbox{\subfigure[Diagramme en z pour $R = 0 \Omega$]{\includegraphics[scale =0.215]{fig/zr0.png} \label{fig:zr0}}
		\subfigure[[Diagramme en z pour $R = 27 \Omega$]{\includegraphics[scale =0.215]{fig/zr25.png} \label{fig:zr25}}}
		\subfigure[[Diagramme en z pour $R = 50 \Omega$]{\includegraphics[scale =0.215]{fig/zr50.png} \label{fig:zr50}}
\end{figure}
\clearpage
\newpage
\subsection{Discussion}
Nous faisons premièrement le constat que les signaux prduits par le générateur ne sont pas idéaux et qu'ils peuvent biaiser la forme des courbes. La bande passante limitée de l'oscilloscope amène des contraintes quant à la visualtion de signaux avec des transitions brusques comme les échelons. Nous pouvons aussi noter la présence d'impédances complexes parasites présentes sur la ligne qui peut modifier la forme des courbes obtenues. Les courbes seront analysées selon la théorie en négligeant ces détails plus techniques.

\paragraph{} La figure \ref{fig:transr0} représente le régime transitoire pour R = 0 $\Omega$ que nous avons mesuré au laboratoire. Lorsque nous comparons avec la figure théorique \ref{fig:r0}, nous remarquons tout de suite la similitude entre les deux courbes. Le signal à la source est complètement atténué après un certain temps. Ceci est causé par le signal réfléchi qui est en opposition de signe avec le signal initial. La courbe en Z théorique pour une résistance de 0 $\Omega$ (figure \ref{fig:zr0}) présente ce comportement. À Z = 0, l'échelon va rencontrer la première droite de 27.2 V au temps t = 0 et crée le front montant. Par la suite, il rencontre la droite de -27.2 V à t = 2T et crée le front descendant. 

\paragraph{}Le signal vu à la charge peut être analysé de la même façon. Le pic est causé par le signal qui rencontre la droite de 27.2 V à environ Z = 30 et t = T et rencontre la droite de -27.2 V quelques nanosecondes plus tard. Ce pic est bien présent dans les deux figures ce qui valide le modèle utilisé. De plus, selon le calcul de la section 1.2.2, le coefficient de réflexion est de -1 ce qui explique la forme des courbes obtenues.
