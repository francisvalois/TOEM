...
Commençons par analyser les courbes pratiques et théoriques pour une résistance de 0 Ohm, en d'autres mots, un court-circuit. La figure \ref{fig:transr0} représente le régime transistoire que nous avons mesurer au laboratoire. Lorsque nous comparons avec la figure théorique \ref{fig:r0}, nous remarquons tout de suite la similitude entre les deux courbes. Le signal à Z = 0, soit à la source, est atténué complètement après un certain temps. Ceci est causé par la réflexion du signal qui est inversé lorsqu'il revient. La courbe en Z théorique lorsque la résistance est de 0 Ohm (figure \ref{fig:zr0} montre bien cet effet. À Z = 0, le signal va rencontrer la première droite de 27.2 V à t = 0 ce qui va créer le front montant de la porte et par la suite, celui-ci va rencontrer la droite -27.2 V à t = 2T ce qui va créer le front descendant. Le signal vu à la charge peut être analysé de la même façon. Le pic est causé par le signal qui rencontre la droit de 27.2 V à environ Z = 30 et t = T. L'incertitude dans un tel montage implique que le signal ne peux pas juste rencontrer la droite positive et celui-ci se doit d'être atténué de 27.2 V quelques nano-secondes plus tard. De plus ce pic est bien présent dans la figure 
